...
void GpioConfigPortA(GPIO_TypeDef *GPIOx)
{
    ...
    for (pinpos = 0x00; pinpos < 0x10; pinpos++)
    {
        ...
        // --- MODIFIED: REMOVED GPIO_Pin_0 AND GPIO_Pin_1 ---
        // Original: currentpin = (GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_6 | GPIO_Pin_7) & pos;
...
void encoder_config()
{
    ...
    // --- MODIFIED: COMMENTED OUT PA0 AND PA1 AF CONFIG ---
    ...
    // --- MODIFIED: COMMENTED OUT TIM2 INIT FOR PA0/PA1 ---
    /*
